 ...
 */
public class Iconos_Unidades_SpinnerAdapter extends ArrayAdapter<IconosUnidades>
{
    private Context context;

    List<IconosUnidades> datos = null;

    public Iconos_Unidades_SpinnerAdapter(Context context, List<IconosUnidades> datos)
    {
